...
import GiftedAvatar from './src/GiftedAvatar';
import GiftedChatInteractionManager from './src/GiftedChatInteractionManager';
...
class GiftedChat extends React.Component {
  ...
  renderMessages() {
    ...
    return (
      <AnimatedView style={{
        height: this.state.messagesContainerHeight-18,
      }}>
        <MessageContainer
          {...this.props}
