...
export default class Bubble extends React.Component {
        ...
        (buttonIndex) => {
          switch (buttonIndex) {
              case 0:
                  ...
                  break;
              // case 1:
              //     this.props.deleteMessage(this.props.currentMessage._id)
              //     break;
          }
        });
      }
  ...
  renderJian(){
    if (this.props.position === 'left'){
      return (
          <Image source={require('../../assets/triangleLeft.png')} style={{width:22,height:22,marginRight:-7,marginTop:8,}} />
      )
    }else if(this.props.position === 'right'){
        return (
            <Image source={require('../../assets/triangleRight.png')} style={{width:22,height:22,marginTop:8,marginLeft:-6.9}} />
        )
    }
    return null;
  }
  ...
  render() {
    return (
      <View style={[styles[this.props.position].container, this.props.containerStyle[this.props.position]]}>
          {this.props.position === 'left' ? this.renderJian() : null}
        <View style={[styles[this.props.position].wrapper, this.props.wrapperStyle[this.props.position], this.handleBubbleToNext(), this.handleBubbleToPrevious()]}>
          ...
          {this.props.position === 'right' ? this.renderJian() : null}
      </View>
    );
  }
}
